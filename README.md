...
Clonagem da tela de login do `Instagram` atráves do curso disponibilizado pela [`DIO`](https://www.dio.me/) no bootcamp [`JavaScript Game Developer`](https://web.dio.me/track/598f2ee3-6af1-4370-a843-2cb9afe2f70f).
...
```bash
  git clone https://github.com/veras-dan/instagram-login-dio
```

Entre no diretório do projeto:

```bash
  cd instagram-login-dio
```
## 📝 Contribuindo
